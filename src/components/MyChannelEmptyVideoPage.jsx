// components/ChannelEmptyVideosPage.jsx
import React from 'react';

const MyChannelEmptyVideosPage = () => {
  return (
    <div className="max-w-4xl mx-auto py-6 px-4">
      ...
      <div className="text-center py-16">
        ...
        <button className="bg-blue-600 hover:bg-blue-700 text-white px-4 py-2 rounded-full text-sm font-medium flex items-center gap-1 mx-auto">
...
export default MyChannelEmptyVideosPage;